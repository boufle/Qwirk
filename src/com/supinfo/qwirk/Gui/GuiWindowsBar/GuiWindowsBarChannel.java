...
import com.supinfo.qwirk.Listener.GuiWindowsBarChannelListener;
 ...
 */
public class GuiWindowsBarChannel extends JPanel {

    private BufferedImage image;

    public GuiWindowsBarChannel(Integer chanID){
        setBackground(new Color(38,51,67));
        setName(String.valueOf(chanID));
        ...
        addMouseListener(new GuiWindowsBarChannelListener());
    }
